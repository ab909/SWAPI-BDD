...
public class peoplesStepDefinition {
	...
	@Then("the user will input a specific character into the search box")
	public void the_user_will_input_a_specific_character_into_the_search_box() {
